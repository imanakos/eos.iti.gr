...
const collaboratingCategories = [
  {
    ...
    anchor: "#phd",
    description:
      "Detection of aquatic pollutants, signal processing, land cover classification with deep learning, and more.",
  },
  {
    label: "MSc Candidates / Fellows",
    anchor: "#msc",
    description:
      "Remote sensing applications, environmental monitoring, and geoinformatics research.",
  },
  {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <div className="mb-12">
          ...
          <p className="text-xl text-muted-foreground">
            Since 2012, 48 personnel units have been engaged in EOS team's activities. Gender
            equality target is almost achieved (52% male and 48% female research assistants).
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground mb-6">
            In the framework of direct cooperation within research lines coupled with EOS team's
            main activities:
          </p>
