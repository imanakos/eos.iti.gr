...
const links = [
  ...
  {
    label: "Results & Deliverables (CORDIS)",
    url: "https://cordis.europa.eu/project/id/641762/results",
  },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm font-semibold text-purple-700 dark:text-purple-400 uppercase tracking-widest">
              Services &amp; Products
            </span>
          </div>
        ...
        <div className="bg-card rounded-2xl border border-border p-8 shadow-sm mb-8">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              The <strong className="text-foreground">EODESM tool</strong> ('Earth Observation Data
              for Ecosystem Monitoring') is a tool developed under the Horizon 2020{" "}
              <a
                href="https://cordis.europa.eu/project/id/641762"
                target="_blank"
            ...
            <p>
              This tool automatically classifies land cover from environmental variables, enabling
              users to detect changes in hydroperiod, changes in vegetation and soil moisture, and
              other environmental variables.
            </p>
            <p>
              EODESM supports detailed land cover classification and change mapping using
              multi-source Earth Observation data, and is designed to be scalable across different
              protected areas and ecosystem types.
            </p>
          </div>
        </div>
        ...
        <div className="bg-muted/50 rounded-2xl border border-border p-6">
          ...
          <p className="text-muted-foreground text-sm">
            EODESM was developed in the context of the ECOPOTENTIAL Horizon 2020 project (Grant
            Agreement No. 641762). The tool and its documentation are referenced at{" "}
            <a
              href="https://www.grida.no"
              target="_blank"
              rel="noopener noreferrer"
