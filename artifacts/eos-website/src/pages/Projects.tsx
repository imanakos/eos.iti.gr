      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <div className="mb-12">
          ...
          <p className="text-xl text-muted-foreground">
            Research projects led and co-led by the EOS team, spanning national, European, and
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 p-5 bg-muted rounded-2xl border border-border">
            ...
            <ul className="space-y-1.5 text-sm text-muted-foreground">
              ...
              <li>
                FP7: INERTIA 'Integrating Active, Flexible and Responsive Tertiary Prosumers into a
                Smart Distribution Grid', 2012–2015
              </li>
              <li>
                FP7: NEMESYS 'Enhanced NETwork Security for Seamless Service Provisioning in the
                Smart Mobile EcoSystem', 2012–2015
              </li>
              <li>
                IPA Cross-Border Cooperation: AITOLOS 'Cross border collaboration to fight illegal
                logging and timber trade', 2012–2014
              </li>
              <li>
                FP7: eCOMPASS 'eCO-friendly urban Multi-modal route PlAnning Services for mobile
                uSers', 2011–2014
              </li>
            </ul>
          </div>
