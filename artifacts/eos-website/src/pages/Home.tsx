      ...
      <section className="relative h-[80vh] min-h-[560px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-16">
          ...
          >
            ...
            monitoring biodiversity, habitats, land cover changes, and water resources.
          </motion.p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  Rational usage of natural resources, food security and climate change impacts'
                  mitigation constitute core drivers for the development of sensors by the European
                  (ESA), American (NASA) and other Space Agencies worldwide, as well as the design
                  and development of remote sensing data processing chains.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                  <em>Eos</em> team innovates in this research with the development of Earth
                  Observation based products and services for monitoring and assessment of
                  biodiversity, habitats, cultivations, resources, and land cover/use changes to
                  support decisions, modeling and scenarios towards sustainability.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 pt-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Copernicus Academy Ambassador Member
                </p>
              </div>
            </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-muted-foreground">
                    Establish sustainable supply chains for Earth observation value added products
                    and services
                  </span>
                </li>
                <li className="flex items-start gap-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore our operational modules and tools transforming satellite data into actionable
              insights.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredServices.map((service, i) => {
              ...
              const cls =
                "group bg-card rounded-3xl p-8 shadow-lg shadow-black/5 border border-border hover:border-primary/30 hover:shadow-xl transition-all duration-300 flex flex-col items-start";
              return service.external ? (
                ...
                <Link key={i} href={service.href} className={cls}>
                  {inner}
                </Link>
              );
            })}
          ...
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Updates from our research and deployments.
              </p>
            </div>
            <Link
              href="/news"
              className="hidden md:flex items-center font-semibold text-primary hover:text-primary/80 transition-colors"
            >
                  ...
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src =
                        `${import.meta.env.BASE_URL}images/structure/plot_final.png`;
                    }}
                  />
                  {news.date && (
