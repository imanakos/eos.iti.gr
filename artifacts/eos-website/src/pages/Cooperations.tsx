...
const cooperations = [
  ...
  },
  {
    ...
    description:
      "European Association of Remote Sensing Laboratories. Dr. Manakos served as Chairman of the Special Interest Group 'Remote Sensing in Land Use & Land Cover' (2011–2021) and Chairman of EARSeL (2012–2014).",
