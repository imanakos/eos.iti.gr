...
const posterItems = [
  ...
  },
  {
    ...
    caption:
      "Bytes από το διάστημα παρακολουθούν τη γη (in Greek), presented at the Researchers' Νight 2019",
  },
  {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <div className="mb-10">
          ...
          <p className="text-xl text-muted-foreground">
            Scientific output of the EOS research team spanning journal articles, books, conference
            papers, and more.
          </p>
        </div>
        ...
        {activeTab === "networking" && (
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-6">
              ...
              <span className="text-base font-normal text-muted-foreground">
                ({networkingPubs.length} entries)
              </span>
            </h2>
            <ol className="space-y-3 list-none">
              {networkingPubs.map((pub, i) => (
                <PubItem key={i} {...pub} />
              ))}
            </ol>
          </section>
        ...
        {activeTab === "press" && (
          <section>
            ...
            <div className="mt-8 bg-amber-50 dark:bg-amber-950/20 rounded-xl border border-amber-200 dark:border-amber-800 p-4 text-sm text-amber-800 dark:text-amber-200">
              <strong>Note:</strong> The <em>Hopfen Rundschau</em> article (Bavaria regional
              journal, August 2024, in German) is available as a{" "}
              <a href={assetUrl("/files/hopfen.pdf")} download className="underline font-semibold">
                PDF download
              </a>
              .
            </div>
