...
export const journalPubs: PubEntry[] = [
  {
...
export const bookPubs: PubEntry[] = [
  {
...
export const networkingPubs: PubEntry[] = [
  {
  ...
  {
    text: "M. Milczarek, S. Aleksandrowicz, A. Kita, R.-T. Chadoulis I. Manakos, E. Woźniak, 2022. Comparative analysis of selected scorched terrain detection methods on Sentinel-2 satellite images. Presentation at the 25th National Conference of Photointerpretation and Remote Sensing , 28-30, November.",
