...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Digital solutions for cotton crop monitoring. A platform providing real-time guidance on best agricultural practices using satellite, telematics, and remote sensing data for cotton farmers in Nestos valley.",
    status: "recent",
  ...
  },
  {
    ...
    description:
      "Digital farming initiative reshaping rice cultivation in Greece. Enables real-time monitoring using satellite imagery, integrated weather data, and in-situ observations for the Axios River Delta.",
    status: "recent",
  ...
  },
  {
    ...
    description:
      "Mediterranean Water Capacity building project leveraging Earth Observation for water resource management across the Mediterranean basin.",
    status: "recent",
  ...
  },
  {
    ...
    description:
      "Water Quality Emergency Monitoring Service (H2020). An EO-based platform for water utilities providing early-warning capabilities. Featured in the Copernicus Observer newsletter.",
    status: "recent",
    url: "https://wqems.eu/",
  },
  {
  ...
  },
  {
    ...
    description:
      "Waste water treatment training and knowledge transfer project with dedicated e-learning content for water utility operators.",
    status: "recent",
  ...
  },
  {
    ...
    description:
      "EuroGEOSS Showcases: Applications Powered by Europe initiative. Demonstrating Earth Observation pilot applications across multiple sectors.",
    status: "recent",
  ...
  },
  {
    ...
    description:
      "Improving future ecosystem benefits through Earth Observations (H2020). Combined satellite and in-situ data to improve modelling and management of protected areas.",
    status: "recent",
